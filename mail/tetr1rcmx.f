      SUBROUTINE TETR1RCMX( NS1, NS2, NS3,  NOTETR, PTXYZD,
     %                      NBSTCF, NOSTCF, NBTECF, NOTECF, NTCOSMAX )
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C BUT :   RETIRER LE TETRAEDRE NTCOSMAX DE SOMMETS NS1 et NS2 ET DONT
C -----   UNE DE SES 2 FACES FORMENT UN ANGLE DE COSINUS MAXIMAL AVEC
...
C          NOTECF( NTCOSMAX ) = -NTECMAX RENDU <0 POUR LE TETRAEDRE Cos MAX

C SORTIE :
C --------
C NTCOSMAX: = 0 SI PAS DE TEL TETRAEDRE DANS NOTECF
...
C....................................................................012
      ...
      DOUBLE PRECISION  COSMAX, COS2FA(2), COSFMX(2), PIS4, DATAN
...
C     DE COSINUS MAXIMAL AVEC LE TRIANGLE NS1 NS2 NS3
...
C               DIFFERENT DE NS1 ET NS2
 ...
 60         IF( NS4 .EQ. 0 ) THEN
               print*,'tetr1rcmx: PROBLEME NTE=',NTE,' NS1=',NS1,
...
ccc     %                     PTXYZD(1,NS4),  ANGLE, IERR2 )
            ...
            print*,'tetr1rcmx: NTE=',NTE,' NS1=',NS1,' NS2=',NS2,
     %             ' NS3=',NS3,' NS4=',NS4,' COS2FA=',COS2FA( MM )
ccc     %            ,' ANGLE=',ANGLE*45D0/PIS4
 ...
 80   ENDDO
      ...
      IF( NTECMAX .GT. 0 ) THEN
         print*,'tetr1rcmx: Retrait du TETRAEDRE de CosMAX=',NTECMAX,
     %          ':',(NOTETR(NN,NTECMAX),NN=1,8),
     %          ' NO Faces Max=',NFAMX,' COSMAX',COSFMX
C        LE TETRAEDRE NTECMAX EST RETIRE EN RENDANT SON NUMERO NOTEFET NEGATIF
         NOTECF( NTCOSMAX ) = -NTECMAX
      ELSE
         print*,'tetr1rcmx: PAS de Retrait de TETRAEDRE de COS MAX pour 
     %la FACE du CF NS1=',NS1,' NS2=',NS2,' NS3=',NS3
      ENDIF
