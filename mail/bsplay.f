      SUBROUTINE BSPLAY( NBCOMP , DEGREX ,   LRX , RX , NBAXQB , RAGXQB,
     %                   DEGREY , LRY , RY , LUY , UY , NBAYQB ,
     %                   SPLINE , XYZSOM,
     %                   NBTGS  , XYZTGS , XYZTST )
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C2345X7..............................................................012
      ...
      REAL     RX(0:LRX),RY(0:LRY),UY(0:LUY),
...
C
C     PROGRESSION GEOMETRIQUE EN X OU NON ?
      PASX0  = ( RX(LRX) - RX(0) )
      IF( ABS(RAGXQB-1.) .LT. 1.E-3 ) THEN
C
...
C        SOMMETS EN PROGRESSION GEOMETRIQUE DANS L'ESPACE DU PARAMETRE
         PASX0  = PASX0 * (1.-RAGXQB) / (1.-RAGXQB**NBAXQB)
      ENDIF
C
