      SUBROUTINE TRATES2AR( KTITRE, PTXYZD, NTE1, NTE2, NBTETRA,NOTETRA,
     %                      NOTETR, NS1, NS2, NS3, NS4, NBXYZP, XYZP )
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C BUT :    TRACE DES ARETES DES NBTETRA TETRAEDRES,
C -----    des TETRAEDRES NTE et NTE2 et DES 2 ARETES NS1-NS2 et NS3-NS4
C ENTREES:
C --------
C KTITRE : TITRE DU TRACE COMPLETE PAR LE NOMBRE DE TETRAEDRES
C PTXYZD : PAR POINT : X  Y  Z  DISTANCE_SOUHAITEE
C NTE1   : NO NOTETR DU TETRAEDRE AVEC SES 6 ARETES A TRACER
C NTE2   : NO NOTETR DU TETRAEDRE AVEC SES 6 ARETES A TRACER
...
C NBXYZP : NOMBRE DE POINTS XYZP A TRACER
C XYZP   : 3 COORDONNEES DES NBXYZP POINTS A TRACER
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C AUTEUR : ALAIN PERRONNET LJLL UPMC & ST PIERRE DU PERRAY  Fevrier 2020
C2345X7..............................................................012
...
C
      DOUBLE PRECISION  PTXYZD(4,*), XYZP(3,NBXYZP)
...
C        LE TRACE DES 6 ARETES DU TETRAEDRE NOTETR(*,NTE)
...
C     LE TRACE DES 6 ARETES DU TETRAEDRE NOTETR(*,NTE2)
      IF( NTE2 .GT. 0 ) THEN
         CALL XVEPAISSEUR( 2 )
         CALL TRTETRA( NCTURQ, NOTETR(1,NTE2), PTXYZD )
C        LE TRACE DU NUMERO DES SOMMETS DU TETRAEDRE NTE2
         DO I = 1, 4
            NS = NOTETR(I,NTE2)
            XYZ(1) = REAL( PTXYZD(1,NS) )
            XYZ(2) = REAL( PTXYZD(2,NS) )
...
C     LE TRACE DES 6 ARETES DU TETRAEDRE NOTETR(*,NTE1)
      IF( NTE1 .GT. 0 ) THEN
         CALL XVEPAISSEUR( 2 )
         CALL TRTETRA( NCCYAN, NOTETR(1,NTE1), PTXYZD )
C        LE TRACE DU NUMERO DES SOMMETS DU TETRAEDRE NTE1
         DO I = 1, 4
            NS = NOTETR(I,NTE1)
            XYZ(1) = REAL( PTXYZD(1,NS) )
            XYZ(2) = REAL( PTXYZD(2,NS) )
            XYZ(3) = REAL( PTXYZD(3,NS) )
            CALL ENTIER3D( NCSAUM, XYZ, NS )
         ENDDO
      ENDIF
