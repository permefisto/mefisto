      SUBROUTINE CHEVPT( POINT, NOTET1, NOTETR, PTXYZD, NOFMAX )
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C BUT :    CALCUL DE LA FACE DU TETRAEDRE PAR LAQUELLE IL FAUT
C -----    SORTIR POUR SE RAPPROCHER DU POINT

C ENTREES:
C --------
C POINT  : LES 3 COORDONNEES DU POINT
C NOTET1 : NUMERO NOTETR DU TETRAEDRE A TRAITER POUR LA FACE DE SORTIE
...
C SORTIE :
C --------
C NOFMAX : NUMERO DE 1 A 4 DE LA FACE DU TETRAEDRE NOTET1 QUI PERMET
C          LA MEILLEURE PROGRESSION EN DIRECTION DU POINT
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C AUTEUR : ALAIN PERRONNET LABORATOIRE ANALYSE NUMERIQUE PARIS JUIN 1991
C MODIFS : ALAIN PERRONNET LJLL UPMC PARIS & VEULETTES SUR MER Mars 2016
C2345X7..............................................................012
      INTEGER           NOTETR(1:8,*), NOSOFA(1:3,1:4)
      DOUBLE PRECISION  PTXYZD(1:4,1:*),POINT(3),COSA,COSMAX
      ...
      DO 10 NOFACE=1,4
         ...
         IF( NOTETR( 4+NOFACE, NOTET1 ) .LE. 0 ) GOTO 10
...
C        DIRIGEE VERS L'EXTERIEUR
         NS1 = NOTETR( NOSOFA( 1, NOFACE ), NOTET1 )
         NS2 = NOTETR( NOSOFA( 2, NOFACE ), NOTET1 )
         NS3 = NOTETR( NOSOFA( 3, NOFACE ), NOTET1 )
