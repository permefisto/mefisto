      SUBROUTINE TRASGIS12A( NBS1,  XYZS1,  NBTRS1, NUSTS1,
     %                       NBS2,  XYZS2,  NBTRS2, NUSTS2,
     %                       MXPTA, XYZPTA,
     %                       MXTRA, NBTRA,  NUSTRA  )
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C BUT :    TRACE DES TRIANGLES DE LA SURFACE 1, 2 et TRIANGLES AJOUTES
C -----    SUR LES SEGMENTS D'INTERSECTION (SGI)
C
C ENTREES:
C --------
...
C NUSTRA : (3,NBTRA) NO DANS XYZPTA DES 3 SOMMETS DES NBTRA TRIANGLES
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C
      ...
      INTEGER           NUSTS1(4,NBTRS1), NUSTS2(4,NBTRS2),
     %                  NUSTRA(3,MXTRA)
C
      REAL              R, COMIMX(3,2), XYZB(3)
...
C     LES X,Y DES 3 SOMMETS POUR LE TRACE DU TRIANGLE NT1
      ...
      IF( NS1 .LE. 0 ) GOTO 40
C
C     NT1 N'EST PAS UN TRIANGLE ELIMINE
...
C     LES X,Y DES 3 SOMMETS POUR LE TRACE DU TRIANGLE NT2
      ...
      IF( NS1 .LE. 0 ) GOTO 80
C
C     NT2 N'EST PAS UN TRIANGLE ELIMINE
...
C
 80   CONTINUE
C
C     LES TRIANGLES DE LA SURFACE AJOUTEE
C     -----------------------------------
      DO 100 NT=1,NBTRA
C
