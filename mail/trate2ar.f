      SUBROUTINE TRATE2AR( KTITRE, PTXYZD, NBTETRA, NOTETRA, NOTETR,
     %                     NS1, NS2, NS3, NS4 )
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C BUT :    TRACE DES ARETES DES NBTETRA TETRAEDRES ET
...
C NS3    : NUMERO 1 PTXYZD DU SOMMET DE l'ARETE NS3 NS4
C NS4    : NUMERO 2 PTXYZD DU SOMMET DE l'ARETE NS3 NS4
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C     TRACE de l'ARETE NS3 NS4
      IF( NS3 .GT. 0 .AND. NS4 .GT. 0 ) THEN
         XYZ(1) = REAL( PTXYZD(1,NS3) )
         XYZ(2) = REAL( PTXYZD(2,NS3) )
         XYZ(3) = REAL( PTXYZD(3,NS3) )

         XYZ2(1) = REAL( PTXYZD(1,NS4) )
         XYZ2(2) = REAL( PTXYZD(2,NS4) )
         XYZ2(3) = REAL( PTXYZD(3,NS4) )

         CALL XVEPAISSEUR( 3 )
         CALL TRAIT3D(  NCMAGE, XYZ,  XYZ2 )
         CALL ENTIER3D( NCSAUM, XYZ,  NS3  )
         CALL ENTIER3D( NCSAUM, XYZ2, NS4  )
      ENDIF
