      SUBROUTINE AJPTNFL( NBVDWH, MXSOMM, NBSOMM, PTXYZD, NPSOFR,
     %                    MXFACO, LEFACO, NBFAPE, NOFAPE,  IERR )
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C BUT :    AJOUT A LA LISTE DES POINTS A TETRAEDRISER DE POINTS SITUES
C -----    SUR LA NORMALE AUX FACES PERDUES DE LEFACO
...
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C AUTEUR : ALAIN PERRONNET LJLL UPMC & St Pierre du Perray    Avril 2016
C....................................................................012
...
C        SUR LA NORMALE A LA FACE (DESSUS et DESSOUS)
     ...
     %                ' ATTEINT'
         ...
         NPSOFR(NBSOMM) = 0
         DO I=1,3
            D = COORNO(I) * BARY(4) * 0.8D0 / NBVDWH
...
ccc      WRITE(IMPRIM,*) 'ajptnfl : Ajout de ',NBSOMM-NBSOM0,
