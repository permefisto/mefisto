      SUBROUTINE SUEXLSDY( NUSURF, NTLXSU,
...
C           OUVERTURE DU FICHIER NMFICH
      ...
      ELSE
         IF( LANGAG .EQ. 0 ) THEN
            PRINT *,'FICHIER: ',NMFICH,' INCONNU'
            PRINT *,'IL DOIT ETRE du TYPE NomSurface.xyzlsd'
         ELSE
            PRINT *,'UNKNOWN FILE NAME: ',NMFICH
            PRINT *,'It MUST be of TYPE NameSurface.xyzlsd'
         ENDIF
         IERR = 1
         GOTO 9010
      ENDIF
...
C           OUVERTURE DU FICHIER NMFICH
      ...
      ELSE
         IF( LANGAG .EQ. 0 ) THEN
            PRINT *,'NOM INCORRECT du FICHIER: ',NMFICH
            PRINT *,'IL DOIT ETRE du TYPE NomSurface.nselsd'
         ELSE
            PRINT *,'INCORRECT FILE NAME: ',NMFICH
            PRINT *,'It MUST be of TYPE NameSurface.nselsd'
         ENDIF
         IERR = 3
         GOTO 9010
      ENDIF
