      SUBROUTINE TETR1ACMX( NS1, NS2, NS3,  N1TETS, NOTETR, PTXYZD,
     %                      NBSTCF, NOSTCF,
     %                      NBTE1A,  MXTE1A, NOTE1A, NTECMAX, IERR )
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C BUT :   AJOUTER LE TETRAEDRE NTECMAX DE SOMMETS NS1 et NS2 ET DONT LES
C -----   2 FACES FORMENT UN ANGLE DE COSINUS MAXIMAL AVEC LE TRIANGLE
C         NS1 NS2 NS3
C
C ENTREES:
C --------
...
C SORTIES:
C --------
C NTECMAX: = 0 SI PAS DE TETRAEDRE
...
C....................................................................012
     ...
     %                  NOSTCF(NBSTCF)
      ...
      DOUBLE PRECISION  COSMAX, COS2FA(2), COSFMX(2), ANGLE, PIS4, DATAN
...
C                    TETRAEDRE AVEC 3 SOMMETS DU CF A AJOUTER
                     NTECMAX = NTE
                     print*,'tetr1acmx: NTECMAX=',NTECMAX,
     %                      ' avec 3 SOMMETS du CF', NS1, NS2, NS,
...
ccc         print*,'tetr1acmx: NTE=',NTE,' NO Faces=',NFA,' COS2FA=',COS2FA
...
C     LE TETRAEDRE NTECMAX EST AJOUTE ( ECRASE LES ANCIENNES VALEURS )
 1000 NBTE1A = NBTE1A0 + 1
      NOTE1A( NBTE1A ) = NTECMAX
...
ccc      IF( COSFMX(1) .GE. COSFMX(2) ) THEN
ccc         MM = 1
ccc      ELSE
ccc         MM = 2
ccc      ENDIF

cccC     LE TETRAEDRE OPPOSE A L'AUTRE FACE DE NTECMAX EST IL A AJOUTER?
ccc      NTEOP = NOTETR( 4+NFAMX(MM), NTECMAX )
...
cccC        NON: LE TETRAEDRE OPPOSE A L'AUTRE FACE DE NTECMAX EST AJOUTE
ccc         NBTE1A = NBTE1A + 1
...
ccc      PRINT *,'tetr1acmx: +',NBTE1A-NBTE1A0,' TETRAEDRES DE SOMMETS',
ccc     %                       NS1,NS2,' COSFMX=',COSFMX
