      SUBROUTINE TR0ACF( NBET,   NA01,   NA1,    NA2,    NA3,
     %                   NF1,    NF2,    NF3,
...
C           IMPLICITEMENT L'ARETE NA1 N'EST PAS UNE ARETE DU TRIANGLE
C NF1,NF2,NF3: NUMERO DU TRIANGLE NOTRIA EXTERIEUR AUX 3 ARETES
...
C     AJOUT DANS NOTRIA DE CE TRIANGLE NF
     ...
     %             N1TRVI, NOTRIA, NOTRSO, NF )
      IF( NF .LE. 0 ) RETURN
C
C     MODIFICATION DU CONTOUR EXISTANT NA1 - NA2
C     ==========================================
