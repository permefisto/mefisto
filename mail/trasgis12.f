      SUBROUTINE TRASGIS12( NBS1, XYZS1,  NBTRS1, NUSTS1, PSGISF1,
     %                      NBS2, XYZS2,  NBTRS2, NUSTS2, PSGISF2,
     %                      MXSGI,NSTSGI, MXCHSGI,LCHSGI, MXPTA,XYZPTA )
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C BUT :    TRACE DES SEGMENTS D'INTERSECTION ENTRE LES TRIANGLES
C -----    DE LA SURFACE 1 ET LES TRIANGLES DE LA SURFACE 2
C
C ENTREES:
C --------
...
C
     ...
     %                  XYZB(3)
C
C     CADRE DE TRACE ENGLOBANT DES 2 SURFACES
      DO K=1,3
         R = REAL( XYZS1( K, 1 ) )
         COMIMX(K,1) = R
         COMIMX(K,2) = R
...
C     TRACE DES AXES
      CALL TRAXE3
C
C     LES TRIANGLES ET SGI DE LA SURFACE 1
C     ------------------------------------
      DO NT1=1,NBTRS1
C
...
C
      ...
      ENDDO
C
C     LES TRIANGLES ET SGI DE LA SURFACE 2
C     ------------------------------------
      DO NT2=1,NBTRS2
C
