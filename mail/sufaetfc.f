      SUBROUTINE SUFAETFC( NOTET1, I, NOTETR, INFACO, MXFACO, LEFACO,
     %                     N1FEOC, N1FEVI, NFETOI, NF2 )
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C BUT :     RETIRER LA FACE I DU TETRAEDRE NOTET1 DE NOTETR DE
C -----     L'ETOILE NFETOI (FACE LEFACO OU NON)
C        ATTENTION SI LA FACE EXISTE DANS NFETOI => ELLE EST SUPPRIMEE
C                             N'EXISTE PAS       => ELLE EST AJOUTEE
C ENTREES :
C ---------
...
C
 10   IF( NF2 .GT. 0 ) THEN
         IF( NFETOI(1,NF2) .NE. NOTET1 .OR.
     %       ABS(NFETOI(2,NF2)) .NE. I ) THEN
C            LA FACE EST DIFFERENTE.PASSAGE A LA SUIVANTE
             NF1 = NF2
             NF2 = NFETOI(5,NF2)
             GOTO 10
         ELSE
C            LA FACE I DU TETRAEDRE NOTET1 EST IDENTIQUE A NF2
...
C               LA FACE NF2=N1FEOC EST LA 1-ERE DE L'ETOILE
      ...
      ENDIF
C
C     LA FACE I DE NOTET1 N'EST PAS RETROUVEE
C     =======================================
...
C        LA FACE EST ELLE DANS LEFACO?
         CALL NULEFT( NFOP, NTOP, NOTETR, MXFACO, LEFACO, NFLE )
         NFETOI(4,NF2) = NFLE
         NFETOI(5,NF2) = 0
