      SUBROUTINE TRVIBF3D( NBPOI,    XYZPOI, NBTETR,
...
C -----    EN TOUS LES POINTS DES EF 3D BREZZI-FORTIN D'UN NCAS
C
C ENTREES:
C --------
C NBPOI  : NOMBRE DE POINTS STOCKES DANS XYZPOI
C XYZPOI : XYZ DES POINTS DES EF DU MAILLAGE
C NBTETR : NOMBRE DE TETRAEDRES BREZZI-FORTIN du MAILLAGE du FLUIDE
...
ccc         IF( MOD(N,NPAFLE) .NE. 0 ) GOTO 20
