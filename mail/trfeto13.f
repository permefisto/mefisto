      SUBROUTINE TRFETO13( KTITRE, PTXYZD, NBTETRA, NOTETRA, NOTETR )
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C
     ...
     %                  DISTOE(MXITEM)
      INTEGER           NOSTTR(MXITEM), ITEMTR(MXITEM), NOSOFA(3,4)
...
C     CALCUL DU BARYCENTRE DES TETRAEDRES OPPOSES
      DO N = 1, NBTETRA
         NTE = ABS( NOTETRA(N) )
         DO M=1,4
            NTEOP = NOTETR(4+M,NTE)
...
C                    LE MAXIMUM
 ...
 7    IF( NBITEM .GE. MXITEM ) THEN
         PRINT*,'trfeto13: AUGMENTER MXITEM=',MXITEM
      ENDIF
