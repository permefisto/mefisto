      SUBROUTINE TRARCH2D( NOCOUL, MOARET, L1ARCH, LARETE, XYZPOI )
C ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C BUT :    TRACER LES ARETES CHAINEES DEFINIES DANS LE TABLEAU LARETE
...
C
C     BOUCLE SUR LES ARETES CHAINEES
      N = L1ARCH
C
 10   IF( N .GT. 0 ) THEN
C
