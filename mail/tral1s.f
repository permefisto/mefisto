     ...
     S                   XYZST )
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C BUT :  CALCULER LES 3 COORDONNEES DU POINT IMAGE DU POINT
C -----  DE COORDONNEES BARYCENTRIQUES (CB(1),CB(2),CB(3)) SUR LE
C        TRIANGLE k PLAN DE LONGUEURS DES COTES EGALES A CELLES
C        DU TRIANGLE K COURBE DE R**3
C        PAR LA FORMULE DE LA TRANSFORMATION TRANSFINIE DU
