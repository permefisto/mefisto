...
C     LE NUMERO D'ARETE DE NS1-NS2 DANS NT1
      ...
      ELSE IF( NOTRIA(3,NT1) .EQ. NS2 ) THEN
         NA = 3
      ELSE
         WRITE(IMPRIM,*) 'DV2T2T: SOMMET ',NS2,' NON DANS TR ',NT1
         GOTO 9999
      ENDIF
      IF( NA .LT. 3 ) THEN
         NA1 = NA + 1
...
C     -------------------------------------------------------
      XG = CETRIA(1,NT) - PXYD(1,NS4)
      YG = CETRIA(2,NT) - PXYD(2,NS4)
      IF( XG*XG + YG*YG .LE. CETRIA(3,NT)*0.9999D0 ) THEN
C
...
C     LE TRIANGLE CONTENANT LES 4 SOMMETS
      ...
      NOTRSO(NS4) = NT
C
C     MISE A JOUR DU CENTRE ET RAYON DES CERCLES CIRCONSCRITS
      NA = 1
      CALL CENCED( PXYD(1,NS2), PXYD(1,NS3), PXYD(1,NS4),
     %             CETRIA(1,NT), NA )
C
      NA = 1
      CALL CENCED( PXYD(1,NS1), PXYD(1,NS4), PXYD(1,NS3),
     %             CETRIA(1,NT1), NA )
C
      IF( TRATRI ) THEN
