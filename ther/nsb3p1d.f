      SUBROUTINE NSB3P1D( NUELEM, NONOEF, Omega,
...
C
      ...
      DOUBLE PRECISION  Rho, NLCOEF, FORCE(2), DELTAK,
     %                  NLSECOEF, NLSECOEF0,
     %                  F1dYF2dXV, F1dYF2dXW,
     %                  VEFtm(4), WEFtm(4),
     %                  VEFtn(4), WEFtn(4),
...
C        CALCUL de ( x dVn+1m/dy - y dVn+1m/dx )(bi)
C        CALCUL de ( x dWn+1m/dy - y dWn+1m/dx )(bi)
         F1dYF2dXV = 0D0
         F1dYF2dXW = 0D0
         DO J=1,4
...
C        -----------------------------
     ...
     %                   MN, FORCE )
         ...
         ENDIF
C
C        CALCUL DES 2 COEFFICIENTS I DU VECTEUR ELEMENTAIRE BE(4,2)
C        ----------------------------------------------------------
         IF( TESTNL .EQ. 6 ) THEN
