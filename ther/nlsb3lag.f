      SUBROUTINE NLSB3LAG( NUELEM, NONOEF, Omega,
...
C        COND = CONDUCTIVITE * (POIDS * DELTA) (bl)
...
C
         CONDP(3,1,L) = COND(4) * S
         CONDP(1,3,L) = COND(4) * S
         CONDP(3,2,L) = COND(5) * S
         CONDP(2,3,L) = COND(5) * S
         CONDP(3,3,L) = COND(6) * S
C
      ENDDO
C
