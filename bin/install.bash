#!/bin/bash
#
#  Alain Perronnet            Version Fevrier 2022  Modifications 18 Octobre 2024
echo
echo ============================================================================
...
then
  ...
  then
    ...
    echo "Cf https://www.ljll.fr/perronnet/mefisto.charger.php"
  else
    echo
    echo "MEFISTO: UNKNOWN Version"
    echo "In this directory, NO file mefisto.MachineName.tgz"
    echo "Cf https://www.ljll.fr/perronnet/mefistoa.charger.php"
  fi
  exit
fi
