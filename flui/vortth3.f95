SUBROUTINE VORTTH3( NBNOVI, XYZNOE, NBELEM, NUNOEF, NONOSO, &
...
!$ USE OMP_LIB
      ...
      INTEGER           NBNOVI, NBELEM, NUNOEF(NBELEM,10),NONOSO(NBNOVI)
...
!$OMP PRIVATE( NUELEM, I, J, K, K1, K2, L, M, N, NS, NCAS ) &
