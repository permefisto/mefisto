...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
! BUT :    CALCULER LE FLUX 2D DE LA VITESSE A TRAVERS LES ARETES
! -----    FRONTALIERES DECLAREES DANS LA DEFINITION DU FLUIDE
!
! ENTREES:
! --------
...
! NUMILG : NUMERO MINIMAL DES LIGNES DANS LA DEFINITION DU FLUIDE
! NUMALG : NUMERO MAXIMAL DES LIGNES DANS LA DEFINITION DU FLUIDE
!
! SORTIES:
! --------
...
! FLUVLG : FLUX DE LA VITESSE A TRAVERS LES LIGNES DU FLUIDE
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
!23456---------------------------------------------------------------012
     ...
     %                  NUMILG, NUMALG
      ...
      INTEGER           K,I,KL,NONOAK(3),NODL,NUELEM,NUDCNB
      CHARACTER*24      KNOMLG
...
!        UNE ARETE DU TRIANGLE EST ELLE FRONTALIERE?
         DO KL = 1, 3
            IF( NULAEF(KL,NUELEM) .GT. 0 ) GOTO 10
         ENDDO
         GOTO 100
...
!     AFFICHAGE DU FLUX DE LA VITESSE SUR LES LIGNES DU FLUIDE
!     =========================================================
      WRITE(IMPRIM,*)
      DO K = NUMILG, NUMALG
