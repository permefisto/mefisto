...
C           NBPOE=4? et pour X?
     ...
     %                  VOLTET, INTVEF, INTVERR, PARAMF(5),
     %                  VitExkI, VitExkJ, XBAR, YBAR, ZBAR, DELTA
      REAL              TIMES(NBVECT)
C
