SUBROUTINE BGDIVTH3( NBSOM,  XYZNOE, NBNOEF, NBELEM, NUNOEF, NONOSO, &
...
!$OMP PRIVATE(NUELEM,NOSOTE,X,Y,Z,DF,DFM1,DET,I,J,K,L,NS)
...
!!!      call affvect( 'bgdivth3.f95: BG=', 20,    BG )
!!!      call afl1ve(  'bgdivth3.f95: BG=', NBSOM, BG )
