...
!///////////////////////////////////////////////////////////////////////
!$OMP PARALLEL DEFAULT(SHARED) PRIVATE(NUELEM,I,J,K,L,M,NS1,NS2,NS3,NS) &
!$OMP PRIVATE( DIVUP2,TDLDL,DELTA,DF,DFM1,DFM1DLA, VN,DGL,X,Y,Z) &
!$OMP PRIVATE( V1,V2,V3,V4, S )
...
!           LE NUMERO EVENTUEL DE LA SURFACE DE CETTE FACE
            NS = NUSFEF(K,NUELEM)
            IF( NS .GT. 0 ) THEN
...
!      call affvect( 'bgdivlath3.f95: BG=', 20,    BG )
!      call afl1ve(  'bgdivlath3.f95: BG=', NBSOM, BG )

      RETURN
END SUBROUTINE BGDIVLATH3
