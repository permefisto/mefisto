     ...
     %                    VXYZPN0, VITMAX, PRESStn, P2P22D, P2P23D,
...
C P2P22D : P2P22D(i,j) = integrale P2i P2j dX SUR LE TRIANGLE
C P2P23D : P2P23D(i,j) = integrale P2i P2j dX SUR LE TETRAEDRE
...
C23456---------------------------------------------------------------012
     ...
     %                  M, K, MEK, NSK
      ...
      DOUBLE PRECISION  PRESStn(NBSOM), VXYZPN0(1:*), VITMAX
...
ccc      print*,'ENTREE de bgvitth.f sans OpenMP'
...
ccc      call affvect( 'BGVITTH VECTEUR BG', 20, BG )
ccc      call afl1ve(  'BGVITTH VECTEUR BG', NDIM*NBNOVI, BG )


cccC     Le TEMPS CPU donne par le systeme en fin d'execution de bgvitth.f
ccc      call cpu_time(t_cpu_1)
 
ccc      print*,'SORTIE de bgvitth.f sans OpenMP en',
