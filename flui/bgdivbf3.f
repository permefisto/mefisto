      SUBROUTINE BGDIVBF3( NBSOM,  XYZNOE, NBSTEF, NBELEM, NOSTEF,
...
! XYZNOE : 3 COORDONNEES DES NBNOVI=NBSOM+NBELEM NOEUDS DU MAILLAGE
...
!           I-eme COEFFICIENT DU VECTEUR ELEMENTAIRE BE
            X = 0D0
            DO J=1,5
!              NO GLOBAL DU NOEUD J DU TETRAEDRE BF
               NS = NOSOTE(J)
               DO K=1,3
...
!!!      call affvect( 'bgdivbf3.f: BG=', 20,    BG )
!!!      call afl1ve(  'bgdivbf3.f: BG=', NBSOM, BG )
