...
C                    CALCUL DE LA PRESSION FIXEE EN CE SOMMET
     ...
     %                            PRESSION )
C                    LE TEMOIN DE FIXATION DU D.L. AU SOMMET NONOE
                     MCN(MNNDLX-1+NONOE) = 1
C                    LA VALEUR DE LA PRESSION FIXEE AU SOMMET NONOE
...
C           NUMERO DU NOEUD
            MCN( MN + NBRDLX ) = I
C           VALEUR FIXEE AU NOEUD
            DMCN(MNVDX+NBRDLX) = DMCN(MNVDX+I)
C           POUR AFFICHER LE DERNIER NOEUD FIXE
            NONOE  = I
...
10170 FORMAT(' NOMBRE DE PRESSIONS FIXEES=',I8,
     %       '  DERNIERE PRESSION',G15.6,' FIXEE AU NOEUD',I9)
20170 FORMAT(' NUMBER of FIXED PRESSURES =',I8,
     %       '  LAST FIXED PRESSURE',G15.6,' at NODE',I9)
C
 9999 RETURN
      END
