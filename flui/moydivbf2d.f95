...
!$OMP PRIVATE(NUELEM, I, J, K, NUNO1T, DFM1, DET, X, Y, X21, Y21, X31, Y31)
!     BOUCLE SUR LES TRIANGLES P1B
!$OMP DO REDUCTION(+:SURFACE) REDUCTION(+:INTDIVV)
      DO NUELEM = 1, NBELEM
...
!///////////////////////////////////////////////////////////////////////
 ...
 print *,'moydivbf2d.f95: SURFACE=',SURFACE,' INTEGRALE div Vxy=',INTDIVV,&
         ' INTEGRALE div Vxy/Surface=',INTDIVV/SURFACE
