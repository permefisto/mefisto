...
!$OMP PRIVATE(NUELEM, I, J, K, L, DF, DET, X, Y, Z)
!     BOUCLE SUR LES TETRAEDRES
!$OMP DO REDUCTION(+:VOLUME) REDUCTION(+:INTP1)
      DO NUELEM = 1, NBELEM
...
!///////////////////////////////////////////////////////////////////////
      ...
      print *,'moyp13d.f95: VOLUME du MAILLAGE=',VOLUME, &
      ' INTEGRALE Pression=',INTP1,' INTEGRALE Pression/VOLUME=',INTP1/VOLUME

      RETURN
END SUBROUTINE MOYP13D
