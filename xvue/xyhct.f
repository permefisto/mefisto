        SUBROUTINE XYHCT( U, V, X, Y,  XHCT, YHCT )
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C       ET POUR LES 9 DEGRES DE LIBERTE STOCKES DANS X ET Y
...
C          ( 0=<U,V<=1  ET V<=1-U )
C X, Y   : VALEURS DES 9 DEGRES DE LIBERTE RANGEES SELON K POUR X ET Y
