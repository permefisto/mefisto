      SUBROUTINE VISE2D( NMTCL0 )
C ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C BUT :  DEFINIR UNE VISEE 2D
C -----  AGRANDISSEMENT OU UNE REDUCTION D'UN TRACE 2D ...
C
C SORTIE :
C --------
...
C
      IF( INTERA .GE. 3 ) THEN
C        PAR DEFAUT EN INTERACTIF  TRANSLATION ZOOM POSSIBLES
         LORBITE = 1
      ELSE
