        SUBROUTINE XYDVS( U, V, X, Y,  XDVS, YDVS )
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C       ET POUR LES 12 DEGRES DE LIBERTE STOCKES DANS X Y
C
C              ^ V
C              |
C              |
...
C          ( 0=<U,V<=1  ET V<=1-U )
C X, Y   : VALEURS DES 12 DEGRES DE LIBERTE RANGEES SELON K POUR X ET Y
C
...
C2345X7..............................................................012
      REAL    U, V, X(12), Y(12), FB(12)
C
C     VALEUR DES 12 FONCTIONS DE BASE DVS AU POINT (U,V)
      CALL VFBDVS( U, V, FB )
C
C     LES COORDONNEES X ET Y POUR LE POINT (U,V) DE L'INTERPOLATION DVS
      XDVS = 0.0
      YDVS = 0.0
      DO 10 I=1,12
         XDVS = XDVS + FB(I) * X(I)
