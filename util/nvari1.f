      SUBROUTINE NVARI1( NOIDEN , NBVARI , NOTYPE , NBV1IN)
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C          TMS      => 21
C NBV1IN : NOMBRE DE VARIABLES DU 1-ER INDICE DU TABLEAU
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C        LE NOMBRE DE SES INDICES
         M      = LETAS( N )
C        LE NOMBRE DE VARIABLES DU 1-ER INDICE DU TABLEAU
         NBV1IN = LETAS(N+2) - LETAS(N+1) + 1
         DO 10 I=1,M
