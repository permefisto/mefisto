      SUBROUTINE ANRALO( A , B , R , PHI )
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C BUT : CALCULER L'ANGLE EN RADIANS DE 0. A 2 PI
...
C PHI    : ANGLE EN RADIANS DE 0. A 2 PI DE AB AVEC L'AXE OX
...
C     L'ANGLE PHI EN RADIANS
      ...
      ELSE
         ...
         KERR(1) = 'ANRALO:POINTS A ET B CONFONDUS X='
     %           //KERR(MXLGER)(1:15)//' Y=' //KERR(MXLGER)(16:30)
         CALL LEREUR
         PHI = 0.
      ENDIF
C
      IF( B(2) - A(2) .LT. 0. ) PHI = PI2 - PHI
      END
