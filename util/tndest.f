      SUBROUTINE TNDEST( KNOM )
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C BUT :    DETRUIRE LE LEXIQUE OU TABLEAU MS OU TABLEAU DE TABLEAUX
...
C ENTREES :
C ---------
C KNOM   : LE NOM A DETRUIRE.IL EST DEFINI PAR PLUSIEURS MOTS SEPARES
...
C     DESTRUCTION DE CE NOM
      CALL LXNMDS( NTLX , KNOM(N1:L) )
      END
