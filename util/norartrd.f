      SUBROUTINE NORARTRD( P1, P2, P3, U, IERR )
C ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C23456---------------------------------------------------------------012
      DOUBLE PRECISION  P1(3), P2(3), P3(3), U(3)
      DOUBLE PRECISION  P21(3), P31(3), VN(3), D, SQRT, A, B, C, E

C     LE VECTEUR NORMAL AU TRIANGLE P1 P2 P3 : ( P2 - P1 ) x ( P3 - P1 )
      CALL VECNOR3D( P1, P2, P3, VN )

C     CARRE DE LA LONGUEUR DU VECTEUR NORMAL
      D = VN(1)**2 + VN(2)**2 + VN(3)**2
      IF( D .LE. 0D0 ) THEN
C        LE TRIANGLE EST INCORRECT
         PRINT*,'norartrd: TRIANGLE DE VECTEUR NORMAL NUL'
         PRINT*,'norartrd: P1=',P1
         PRINT*,'norartrd: P2=',P2
         PRINT*,'norartrd: P3=',P3
         IERR = 1
         GOTO 9999
      ENDIF
      IERR = 0
