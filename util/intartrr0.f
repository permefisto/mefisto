      SUBROUTINE INTARTRR0( S1, S2, P1, P2, P3,  LINTER, PTI, CBT )
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C23456...............................................................012
      IMPLICIT  NONE
      REAL              S1(3), S2(3), P1(3), P2(3), P3(3)
      DOUBLE PRECISION  CBT(3), PTI(3), A, B, C, D, E, COSA, F, S, R
      INTEGER           LINTER
...
C     TRIANGLE PTI-P1 PTI-P2
     ...
     %  - ( P1(2) - PTI(2) ) * ( P2(1) - PTI(1) )
      ...
      IF( CBT(1) .GE. -0.001D0 .AND. CBT(1) .LE. 1.001D0 .AND.
     %    CBT(2) .GE. -0.001D0 .AND. CBT(2) .LE. 1.001D0 .AND.
     %    CBT(3) .GE. -0.001D0 .AND. CBT(3) .LE. 1.001D0 ) THEN
