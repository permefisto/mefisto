      SUBROUTINE LAR2F( NBSOMM,    XYZSOM,    L1ARET, L2ARET, LARETE,
...
C ----- DES COUPLES DE TRIANGLES ADJACENTS COLLES C-A-D
C       LES 2 TRIANGLES SONT COPLANAIRES DU MEME COTE DE LEUR ARETE COMMUNE
C       et DES ARETES de LARETE APPARTENANT A 2 et SEULEMENT 2 TRIANGLES

C REMARQUE: UNE ARETE ADJACENTE A 2 TRIANGLES COLLES N'APPARTIENT PAS
C           AU TABLEAU MNAR2F DES ARETES DE 2 TRIANGLES
...
C     RECHERCHE DES ARETES APPARTENANT A 2 FACES
...
C                 AJOUT de l'ARETE NA du TABLEAU LARETE
 ...
 9999 IF( LANGAG .EQ. 0 ) THEN
         PRINT*,'lar2f:',NBAR2FCOL,' COUPLES de TRIANGLES COLLES'
         PRINT*,'lar2f:',NBAR2F,' ARETES de 2 TRIANGLES'
      ELSE
         PRINT*,'lar2f:',NBAR2FCOL,' COUPLES of GLUED TRIANGLES'
         PRINT*,'lar2f:',NBAR2F,' EDGES of 2 TRIANGLES'
      ENDIF
