      SUBROUTINE AFTAR1( NBIND, MIMX, MOT, T )
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C BUT : AFFICHER LE TABLEAU REEL DE NBIND INDICES
C -----
C
C ENTREES:
C --------
...
C        PLUS DE MXIND INDICES
         WRITE(IMPRIM,*) 'ERREUR AFTAR1: PLUS DE ',MXIND,' INDICES'
         CALL XVPAUSE
      ENDIF
C
