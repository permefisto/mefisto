      SUBROUTINE SDRES16( NTLXOB , MNR , MNZ , KNOMAC )
C ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C BUT : PRECONDITIONNEMENT DU RESIDU (METHODE DES JOINTS) : REMONTEE
C -----
C
C ENTREE :
C ---------
...
C
C     PRECONDITIONNEMENT : REMONTEE
C     -----------------------------
      CALL RECHGC(NTDL,MCN(MNLPLI),MCN(MNLPCO),MCN(MNAGC),
     S                 MCN(MNR),MCN(MNZ))
C
      RETURN
      END
