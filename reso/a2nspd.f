...
C A2    : MATRICE NON SYMETRIQUE STOCKEE SOUS FORME PROFIL
C
C SORTIE:
C -------
...
C           LA PARTIE COMMUNE A LA LIGNE I DE A1 ET A2
   24       L = L + 1
            ...
            DO 5 J=L,I1
                 ...
                 A3(IA3+N3) = ALFA1 * A1(IA1+N1) + ALFA2 * A2(IA2+N2)
    5       CONTINUE
C
