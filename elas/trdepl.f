      SUBROUTINE TRDEPL( KNOMOB, MODECO, NDIM,
...
C           CE SP POUR BENEFICIER DES INDICES EN CLAIR
            CALL TRDEP2( AMPLID, NCAS, NDIMLI,
...
C        ===================================================================
         CALL TRDEP3( MODECO, KNOMOB, MNXYZN, NCAS, NTDL, NBVECT,
     %                MCN(MNDEPL+WECTEU), AMPLID )
C
      ENDIF
      GOTO 100
C
